    ...
    <header class="relative min-h-[max(45vh,320px)] flex items-center justify-center overflow-hidden">
      ...
      <div class="relative text-center text-white z-10 px-4 py-10">
        ...
        <div class="relative inline-flex flex-col items-center mt-4 group/tip">
          ...
          <div class="relative mt-3 w-[900px] max-w-[95vw] px-10 py-3 rounded-xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-white/25 dark:border-gray-700/20 shadow-lg opacity-0 invisible group-hover/tip:opacity-100 group-hover/tip:visible transition-all duration-300 pointer-events-none">
